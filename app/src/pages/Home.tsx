            ...
            >
              <div className="relative">
                <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-white shadow-xl shadow-blue-900/10">
                  <div className="relative h-64 md:h-72 mb-6 rounded-xl overflow-hidden bg-gradient-to-br from-blue-50/50 to-indigo-50 flex items-center justify-center border border-blue-100/50 shadow-inner">
                    <motion.img
                      key={slideIndex}
                      src={heroSlides[slideIndex]}
                      alt="Featured weighing scale"
                      className="w-full h-48 md:h-64 object-contain drop-shadow-2xl"
                      loading="eager"
                  ...
                  <div className="text-center">
                    <h3 className="text-xl md:text-2xl font-bold text-slate-800 mt-1 mb-6">
                      Our Top Scales Collection
                    </h3>
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Link to="/products" className="flex-1 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 shadow-md hover:shadow-lg hover:shadow-blue-500/25">
                        View All Products <ArrowRight className="w-4 h-4" />
                      </Link>
                      <Link to="/quote" className="flex-1 py-3 bg-white border-2 border-blue-100 text-blue-700 hover:bg-blue-50 hover:border-blue-300 rounded-xl font-bold transition-all duration-300">
                        Get Quote
                      </Link>
                    </div>
                  </div>
