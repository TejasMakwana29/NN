...
export const categories: Category[] = [
  {
    ...
    image: '/images/category-counter.png',
    types: [
      {
        id: 'cs-emboss',
        name: 'Emboss Body',
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '1 kg', image: '/images/counter-emboss-body.png' },
              { weight: '2 kg', image: '/images/counter-emboss-body.png' },
              { weight: '5 kg', image: '/images/counter-emboss-body.png' },
              { weight: '10 kg', image: '/images/counter-emboss-body.png' },
              { weight: '15 kg', image: '/images/counter-emboss-body.png' }
            ],
            baseCapacity: '1 kg - 15 kg',
            precision: 'N/A',
            image: '/images/counter-emboss-body.png',
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '10 kg', image: '/images/counter-plain-body.png' },
              { weight: '15 kg', image: '/images/counter-plain-body.png' },
              { weight: '25 kg', image: '/images/counter-plain-body.png' }
            ],
            baseCapacity: '10 kg - 25 kg',
            precision: 'N/A',
            image: '/images/counter-plain-body.png',
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '1 kg', image: '/images/counter-super-body.png' },
              { weight: '2 kg', image: '/images/counter-super-body.png' },
              { weight: '5 kg', image: '/images/counter-super-body.png' },
              { weight: '10 kg', image: '/images/counter-super-body.png' }
            ],
            baseCapacity: '1 kg - 10 kg',
            precision: 'N/A',
            image: '/images/counter-super-body.png',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '10 kg', image: '/images/electronic-micro-scale.png' }],
            baseCapacity: '10 kg',
            precision: '1 gm',
            image: '/images/electronic-micro-scale.png',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '30 kg', image: '/images/electronic-tabletop-scale.png' }],
            baseCapacity: '30 kg',
            precision: '5 gm',
            image: '/images/electronic-tabletop-scale.png',
            bodyMaterial: 'Steel',
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '50 kg', image: '/images/electronic-poultry-scale.png' },
              { weight: '100 kg', image: '/images/electronic-poultry-scale.png' },
              { weight: '150 kg', image: '/images/electronic-poultry-scale.png' },
              { weight: '200 kg', image: '/images/electronic-poultry-scale.png' }
            ],
            baseCapacity: '50 kg - 200 kg',
            precision: '10 gm to 50 gm',
            image: '/images/electronic-poultry-scale.png',
            bodyMaterial: 'M.S.',
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '50 kg', image: '/images/electronic-platform-scale.png' },
              { weight: '100 kg', image: '/images/electronic-platform-scale.png' },
              { weight: '200 kg', image: '/images/electronic-platform-scale.png' },
              { weight: '300 kg', image: '/images/electronic-platform-scale.png' },
              { weight: '500 kg', image: '/images/electronic-platform-scale.png' },
              { weight: '1 Ton', image: '/images/electronic-platform-scale.png' },
              { weight: '2 Ton', image: '/images/electronic-platform-scale.png' }
            ],
            baseCapacity: '50 kg - 2 Ton',
            precision: '10 gm to 200 gm',
            image: '/images/electronic-platform-scale.png',
            bodyMaterial: 'M.S.',
            panMaterial: 'Chequered (MS) or Stainless Steel',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '510 gm', image: '/images/electronic-jewellery-scale.png' }],
            baseCapacity: '510 gm',
            precision: '10 mg (0.01 gm)',
            image: '/images/electronic-jewellery-scale.png',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '10 kg', image: '/images/electronic-kitchen-scale.png' }],
            baseCapacity: '10 kg',
            precision: '1 gm',
            image: '/images/electronic-kitchen-scale.png',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '180 kg', image: '/images/electronic-personal-body-scale.png' }],
            baseCapacity: '180 kg',
            precision: '50 gm',
            image: '/images/electronic-personal-body-scale.png',
            displayType: 'LED display',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '50 kg', image: '/images/electronic-luggage-scale.png' }],
            baseCapacity: '50 kg',
            precision: '10 gm',
            image: '/images/electronic-luggage-scale.png',
            bodyMaterial: 'ABS',
  ...
  },
  {
    ...
    image: '/images/category-hanging.png',
    types: [
      {
        id: 'hs-circular',
        name: 'Circular',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '25 kg', image: '/images/hanging-circular-25kg.png' }],
            baseCapacity: '25 kg',
            precision: '100 gm',
            image: '/images/hanging-circular-25kg.png',
            brand: 'Paras',
          ...
          },
          {
            ...
            description: 'At Manish Scale, we manufacture best-in-class circular hanging spring balances—a perfect blend of precision engineering, durability, and reliable performance. Designed to meet the highest standards, our scales deliver consistent accuracy and ensure complete customer satisfaction.\n\nBuilt with a high-strength aluminum body and a crystal-clear fiber-glass display, our scale is designed to withstand tough working conditions while maintaining flawless readability. The reinforced heavy-duty hooks ensure superior strength and reliability, even under continuous use.\n\nCrafted with an attractive design and backed by our registered trademark, these scales are available under our trusted brands Paras and Shubham.\n\nWidely used across industries such as agriculture, metal processing, pharmaceuticals, laboratories, and hospitals, our circular hanging scales are known for their versatility, strength, and dependable performance. It also features a zero adjustable knob to easily reset the scale.',
            capacities: [{ weight: '100 kg', image: '/images/hanging-circular-100kg.png' }],
            baseCapacity: '100 kg',
            precision: '500 gm',
            image: '/images/hanging-circular-100kg.png',
          ...
          },
          {
            ...
            description: 'At Manish Scale, we manufacture best-in-class circular hanging spring balances—a perfect blend of precision engineering, durability, and reliable performance. Designed to meet the highest standards, our scales deliver consistent accuracy and ensure complete customer satisfaction.\n\nBuilt with a high-strength aluminum body and a crystal-clear fiber-glass display, our scale is designed to withstand tough working conditions while maintaining flawless readability. The reinforced heavy-duty hooks ensure superior strength and reliability, even under continuous use.\n\nCrafted with an attractive design and backed by our registered trademark, these scales are available under our trusted brands Paras and Shubham.\n\nWidely used across industries such as agriculture, metal processing, pharmaceuticals, laboratories, and hospitals, our circular hanging scales are known for their versatility, strength, and dependable performance. It also features a zero adjustable knob to easily reset the scale.',
            capacities: [{ weight: '200 kg', image: '/images/hanging-circular-200kg.png' }],
            baseCapacity: '200 kg',
            precision: '1 kg',
            image: '/images/hanging-circular-200kg.png',
            brand: 'Paras, Shubham, Ajanta',
            bodyMaterial: 'Aluminium',
            displayType: 'Strong Fiber glass display',
            warranty: '1 year (t&c apply)',
        ...
        products: [
          {
            ...
            capacities: [{ weight: '100 kg', image: '/images/hanging-pocket-100kg.png' }],
            baseCapacity: '100 kg',
            precision: '500 gm',
            image: '/images/hanging-pocket-100kg.png',
            brand: 'Paras, Fish',
            bodyMaterial: 'Steel',
            adjustable: 'No',
            hook: 'High strength hook at top & bottom'
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '50 kg', image: '/images/hanging-tubular.png' },
              { weight: '100 kg', image: '/images/hanging-tubular.png' }
            ],
            baseCapacity: '50 kg & 100 kg',
            precision: '50 gm',
            image: '/images/hanging-tubular.png',
            brand: 'Paras',
            bodyMaterial: 'Steel',
            adjustable: 'Yes (zero adjust knob)',
            hook: 'High strength hook at top & bottom'
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '3 Ton', image: '/images/hanging-crane.png' },
              { weight: '5 Ton', image: '/images/hanging-crane.png' },
              { weight: '10 Ton', image: '/images/hanging-crane.png' }
            ],
            baseCapacity: '3 Ton - 10 Ton',
            precision: '1 kg',
            image: '/images/hanging-crane.png', 
            brand: 'Paras',
        ...
        products: [
          {
            ...
            capacities: [
              { weight: '100 kg', image: '/images/hanging-digital.png' },
              { weight: '200 kg', image: '/images/hanging-digital.png' }
            ],
            baseCapacity: '100 kg & 200 kg',
            precision: '500 gm, 1 kg',
            image: '/images/hanging-digital.png',
            brand: 'Paras, Shubham',
            bodyMaterial: 'Aluminium',
            displayType: 'LED dual display',
  ...
  },
  {
    ...
    image: '/images/category-beam.png',
    types: [
      {
        id: 'beam-class-c',
        name: 'Class C',
